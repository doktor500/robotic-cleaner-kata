...
* can make use of any existing open source libraries that don't directly address the problem.

## Requirements

Java 12 with the experimental features enabled
...
#### Execute jar file
    ...
    java --enable-preview -jar ./build/libs/robotic-cleaner-0.0.1-SNAPSHOT.jar
...
If you are using Inteliij Idea, you will need the lombok plugin and you will need to enable annotation processing as well as the Java 12 preview language settings.
